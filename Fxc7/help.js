...
➻ *${prefix}cphlogo [CURSED/BOT]*
➻ *${prefix}cglitch [CURSED/BOT]*
➻ *${prefix}cpubg [CURSED/BOT]*
➻ *${prefix}cml [Lancelot/CURSED]*

➻ *${prefix}tahta [CURSED]*
➻ *${prefix}croman [CURSED dan BOT]*
➻ *${prefix}cthunder [CURSED]*
➻ *${prefix}cbpink [CURSED]*
➻ *${prefix}cmwolf [CURSED]*
➻ *${prefix}csky [CURSED]*
➻ *${prefix}cwooden [CURSED]*
➻ *${prefix}cflower [CURSED]*
➻ *${prefix}clove [CURSED]*
➻ *${prefix}ccrossfire [CURSED]*
➻ *${prefix}cnaruto [CURSED]*
➻ *${prefix}cparty [CURSED]*
➻ *${prefix}cshadow [CURSED]*
➻ *${prefix}cminion [CURSED]*
➻ *${prefix}cneon [CURSED]*
➻ *${prefix}cneon2 [CURSED]*
➻ *${prefix}cneongreen [CURSED]*
➻ *${prefix}c3d [CURSED]*
➻ *${prefix}csky [CURSED]*
...
╭──────────────────────────
┴
➻ *${prefix}jarak [Jakarta/Surabaya]*
➻ *${prefix}translate [en/Apa kabar?]*
➻ *${prefix}pasangan [Cursed/Ading]*
➻ *${prefix}gantengcek [Fatan]*
➻ *${prefix}cantikcek [Iriene]*
➻ *${prefix}artinama [Cursed]*
➻ *${prefix}persengay [Topan]*
➻ *${prefix}pbucin [Cursed]*
➻ *${prefix}bpfont []*
➻ *${prefix}textstyle [CURSED]*
➻ *${prefix}jadwaltv [gtv]*
...
➻ *${prefix}spamgmail [coinmanaduit@gmail.com*
┬
╰────────────────────────
